...
class MoonRegistrar():
    ...
    def draw_red_transformed_user_image(self, transformed_image_in:numpy.ndarray = numpy.array()) -> numpy.ndarray: ...
    def draw_green_model_image(self) -> numpy.ndarray: ...
    def draw_stacked_red_green_image(self, transformed_image_in:numpy.ndarray = numpy.array()) -> numpy.ndarray: ...
